  ...
  if (!orders.length) {
    return (
      <div className="text-center py-8 text-[#94a3b8]">
        ...
        <p className="text-[13px]">No pending deliveries awaiting verification</p>
      </div>
    );
  }
...
function SuccessScreen({ result, onReset }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center gap-6 bg-[#030712]">
      ...
      <div>
        <h2 className="text-[22px] font-bold text-white mb-2">Delivery Verified!</h2>
...
export default function EmployeeScan() {
  ...
  const [phase, setPhase] = useState("pick"); // "pick" | "scan" | "done"
  ...
  return (
    <div className="min-h-screen bg-[#030712] flex flex-col text-white">
      <div className="bg-[#131921] border-b border-[#1e293b] px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-[16px] font-bold text-white">Delivery Verification Scan</h1>
      ...
      {phase === "pick" && (
        <div className="flex-1 flex flex-col gap-0 overflow-y-auto">
          <div className="px-4 pt-5 pb-3">
            <h2 className="text-[15px] font-bold mb-1">Select Delivery to Verify</h2>
            <p className="text-[12px] text-[#94a3b8]">
              Choose the order you're delivering. A guided live video scan creates the product baseline
        ...
        <div className="flex-1 flex flex-col" style={{ minHeight: 0 }}>
          {submitting ? (
            ...
            <LiveVideoScanner
              ...
              subtitle="Follow motion guides to capture all product angles"
